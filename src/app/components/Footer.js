    ...
    const socialLinks = [
        {
            ...
            ,
            link: "https://www.youtube.com/@ExpertAdblocker"
        },
        {
            ...
            link: "https://www.facebook.com/people/Expert-adblocker/61559820448281/"
        },
        {
            icon: (<svg className="m-auto" width="50%" viewBox="0 0 46 46" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            link: "https://www.instagram.com/expertadblocker/"
        },
            ...
            <div className={`${data?.bgColor} rounded-tl-[6.5rem]  pt-10 rounded-tr-[6.5rem]`}>
                ...
                <div className='w-[70%] md:w-[30%]  m-auto flex-wrap gap-5 flex justify-evenly pb-5'>
                    {socialLinks?.map((item, index) => (
                        <a target='blank' key={index} href={item.link} className=' hover:scale-90 transition-all ease-in-out  py-2 min-w-[8rem] md:min-w-[0rem] text-[2rem] w-[20%] '>{item.icon}</a>
                    ))}
                </div>
