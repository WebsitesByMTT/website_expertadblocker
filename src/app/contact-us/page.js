      ...
      <div className='py-10'>
          <div className='bg-[#0B1418] py-20 rounded-[3rem] w-[95%] md:w-[85%] mx-auto'>
             <div className='grid grid-cols-12 items-center'>
                <div className='col-span-12 order-2 md:order-1 md:col-span-6'>
                  <div className='w-[90%] md:w-[80%] mx-auto space-y-8'>
                     <div className='space-y-3'>
                        <div className='text-white text-[1.2rem]'>Name And Last Name</div>
                        <input type='text' name='fullname' className='w-full outline-none border-[1px] text-[1.4rem] md:text-[1rem] text-white bg-transparent border-red-500 rounded-lg py-[1rem] md:py-2 px-5'/>
                     </div>
                     <div className='space-y-3'>
                        <div className='text-white text-[1.2rem]'>Email</div>
                        <input type='email' name='email' className='w-full outline-none border-[1px] text-white bg-transparent text-[1.4rem] md:text-[1rem] border-red-500 rounded-lg py-[1rem] md:py-2 px-5'/>
                     </div>
                     <div className='space-y-3'>
                        <div className='text-white text-[1.2rem]'>Phone</div>
                        <input type='text' name='phoneNumber' className='w-full outline-none border-[1px] text-white bg-transparent text-[1.4rem] md:text-[1rem] border-red-500 rounded-lg py-[1rem] md:py-2 px-5'/>
                     </div>
                     <div className='space-y-3'>
                        <div className='text-white text-[1.2rem]'>How Can We Help</div>
                        <textarea className='w-full outline-none border-[1px] text-white resize-none bg-transparent border-red-500 text-[1.4rem] md:text-[1rem] rounded-lg py-[1rem] md:py-2 px-5' rows={7} ></textarea>
                     </div>
                     <div>
                       <button className='rounded-md text-white text-[1.5rem] hover:scale-90 transition-all hover:bg-opacity-70 bg-[#F02828] px-4 py-[4px]'>SUBMIT</button>
                     </div> 
                  </div>
                </div>
