...
const Terms = () => {
  const data = {
    ...
    intro: 'These Terms of Service and End User License Agreement (collectively, the "Agreement") are an agreement conducting business (or trading) as an <a href="/" class="text-blue-500">Expert adblocker</a> and you. This Agreement establishes the terms and conditions for your use of all our Security Group goods and services. Within the limits of such Services, this Agreement applies to both (i) your service plan and (ii) any extra services you acquire to supplement your service plan, as indicated on our Services and Prices page. <br/>By accessing, using, registering for, or receiving any of the Services, if you agree to the terms and conditions listed below and those included in our Privacy Policy, which will be integrated by reference into this Agreement. Additionally,  terms will be applied to specific Services that you purchase. In such instances, the supplementary terms will apply in addition to this Agreement. <br/>You are not permitted to access or use the Services if you disagree with these Terms and Conditions and our Privacy Policies. <br/>Our Security Group has the right to alter this Agreement from time to time to reflect changes in or requirements of relevant law, as well as revisions or updates to the Services. Our security group shall notify you if such a change materially impacts your rights under this Agreement. Changes will not apply retroactively, and unless the change is necessary to be effective instantly for regulatory or security purposes, notice of the amended terms will be provided at least a reasonable time before the changes take effect. If you disagree to be bound by this Agreement, our privacy policies, or any later changes, you must discontinue using the Services.',
    ...
    text2: [
      ...
      "All fees and taxes will be processed on our behalf by the Security LLC. This will not affect the pricing indicated in Our Services & pricing, and you will incur no additional fees",
